...
const projectId = "2NpH47QLzq8794bjZmxTTnnhlEi";
const projectSecretKey = "44ed8dfe7b88700bebe8d40e5a12539d";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://voting-organization.infura-ipfs.io";
